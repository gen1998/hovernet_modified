...
class InferManager(base.InferManager):
    ...
    ####
    def process_file_list(self, run_args, file_path_list):
        """
        ...
        while len(file_path_list) > 0:
            ...
            print("available_ram", available_ram, len(file_path_list))
            ...
            print("num images", len(use_path_list))
            ...
            del cache_image_list, cache_patch_info_list, cache_image_info_list
            ...
            if first_flag:
                first_flag = False
                first_num_image = len(use_path_list)
            elif len(use_path_list) < first_num_image//2:
